...
def main():
    if len(sys.argv) != 2:
        print("Usage: python3 cwe_tree_xml_to_json.py path/to/cwe_tree.xml")
        sys.exit(1)

    # the cwe tree file (XML file) given by the user
    cwe_xml = sys.argv[1]
    ...
    with open(cwe_xml, "r") as f:
        ...
        print(json.dumps(cwe_tree, indent=4, sort_keys=True))
